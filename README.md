...
##### Multi-Arch images
- `Insightops`
  - `docker pull fluent/fluentd-kubernetes-daemonset:v1.16.5-debian-insightops-1.0`
  - `docker pull fluent/fluentd-kubernetes-daemonset:v1.16-debian-insightops-2`

##### x86_64 images
- `Insightops` [Dockerfile](docker-image/v1.16/debian-insightops/Dockerfile)
  - `docker pull fluent/fluentd-kubernetes-daemonset:v1.16.5-debian-insightops-amd64-1.0`
  - `docker pull fluent/fluentd-kubernetes-daemonset:v1.16-debian-insightops-amd64-2`
